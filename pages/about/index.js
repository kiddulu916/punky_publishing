  ...
  return (
    <div className='h-full bg-primary/30 py-32 text-center xl:text-left'>
      ...
      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
        ...
        >
          <div className='container mx-auto flex flex-col w-full items-center justify-center top-[30px] xl:top-0 text-center text-sm xl:text-[18px]'>
            <div className='flex flex-col gap-y-2'>
              ...
              <p className='indent-8 md:indent-8 lg:indent-8 xl:indent-8 text-[14px] md:text-[16px] lg:text-[16px] leading-normal md:leading-tight lg:leading-tight xl:leading-tight xl:text-[18px] text-white'>Our journey into learning various programs began as a hobby. Still, it quickly evolved into a career as we discovered the joy of creating immersive and engaging ways to teach or guide people in their journey. We have since worked on numerous successful projects, gaining a wealth of experience across various programs, platforms, and genres. This hands-on experience has fueled our passion for teaching and sharing our insights with others.<br /></p> 
              <p className='hidden indent-8 md:indent-8 lg:indent-8 xl:indent-8 md:text-[16px] md:flex lg:flex xl:flex md:leading-tight lg:leading-tight leading-normal xl:leading-tight xl:text-[18px] text-white'>Through our books, we aim to demystify the complexities of various niches, offering clear, step-by-step guides that are approachable for beginners yet rich with advanced techniques. Our writings are not just about content; it&apos;s also about learning, and it&apos;s about storytelling, creativity, and the art of crafting experiences that resonate with people.<br /></p>
              <p className='hidden indent-8 md:indent-11 lg:indent-11 xl:indent-11 md:text-[16px] xl:flex md:leading-tight lg:leading-tight leading-normal xl:leading-tight xl:text-[18px] text-white'>Our mission is to make any niche accessible to everyone, regardless of their technical background. We believe that anyone with a passion can learn, and our books have become trusted resources for those looking to start their journey or take their skills to the next level.</p>
